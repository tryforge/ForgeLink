...
const LavalinkCommandManager_1 = require("./classes/managers/LavalinkCommandManager");
const ascii_table3_1 = require("ascii-table3");
const path_1 = require("path");
(0, forgescript_1.generateMetadata)((0, path_1.join)(__dirname, "natives"), "natives", LavalinkCommandManager_1.handlerName, true, void 0, (0, path_1.join)(__dirname, "events"))

...
const KazagumoCommandManager_1 = require("./classes/managers/KazagumoCommandManager");
const ascii_table3_1 = require("ascii-table3");
const path_1 = require("path");
(0, forgescript_1.generateMetadata)((0, path_1.join)(__dirname, "natives"), "natives", KazagumoCommandManager_1.handlerName, true, void 0, (0, path_1.join)(__dirname, "events/kazagumo"))
...
function generateFunctionDocs() {
    ...
    for (const func of data) {
        ...
        content.push(`View source on [GitHub](https://github.com/tryforge/forgelink/blob/dev/src/natives/${func.name.slice(1)}.ts)`);
